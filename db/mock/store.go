...
// Source: github.com/blancogames4/simplebank/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/blancogames4/simplebank/db/sqlc"
...
// GetRecentTransfers mocks base method.
func (m *MockStore) GetRecentTransfers(arg0 context.Context, arg1 sqlc.GetRecentTransfersParams) ([]sqlc.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRecentTransfers", arg0, arg1)
	ret0, _ := ret[0].([]sqlc.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRecentTransfers indicates an expected call of GetRecentTransfers.
func (mr *MockStoreMockRecorder) GetRecentTransfers(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRecentTransfers", reflect.TypeOf((*MockStore)(nil).GetRecentTransfers), arg0, arg1)
}
...
func (m *MockStore) GetTransfersBetweenAccounts(arg0 context.Context, arg1 sqlc.GetTransfersBetweenAccountsParams) ([]sqlc.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUsers(arg0 context.Context, arg1 string) (sqlc.User, error) {
	m.ctrl.T.Helper()
